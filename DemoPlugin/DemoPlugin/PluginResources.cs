namespace Loupedeck.ShutdownTimer
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `ShutdownTimer.Resources`.
        // Returns the full names of the resource files, for example, `ShutdownTimer.Resources.Resource.txt`.
